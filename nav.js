...
(function () {
  ...
  function setActive(root) {
    ...
    else if (/^\/(ad-hoc-research|rfa-signing-calendar|salary-cap-spend|agency-power-rankings|2026-draft-by-agency|draft-capital|lottery-pick-distribution|wiggins-contract)/.test(path)) section = 'research';
