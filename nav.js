...
(function () {
  ...
  function setActive(root) {
    ...
    else if (/^\/(ad-hoc-research|rfa-signing-calendar|salary-cap-spend|agency-power-rankings|2026-draft-by-agency|draft-capital|lottery-pick-distribution|wiggins-contract|one-year-min-all|one-year-min-u30)/.test(path)) section = 'research';
